...
(function (root, factory) {
    ...
    /**
     * Custom Function to Update Gauge Max Value
     * 
     * @param {String} label The Label
     */
    JustGage.prototype.refreshMaxValue = function(maxValue) {
       var obj = this; if (maxValue != null ) { obj.txtMax.attr({ "text": maxValue }); 
      }}

    /**
     * Custom Function to Update Gauge label
     * 
     * @param {String} label The Label
     */
    JustGage.prototype.refreshLabel = function(label) {
      var obj = this; if (label && (typeof label == "string")) { obj.txtLabel.attr({ "text": label }); 
     }}
